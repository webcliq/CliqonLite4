...
/**
 * 
 * Various Classes and Functions to support install
 * @author markr
 */
...
class clqlcd {
    ...
    *******************************************/
    ...
    function get_languages($feature, $spare='') {
        ...
        else { $user_languages[0] = array('ca','es','de','en'); }; // return default array if no languages found
        ...
        if ( $feature == 'header' ) {
        $ulcd = substr($user_languages[0][1],0,2);
        return $ulcd;	
        };
    }
...
class sqlImport {
    ...
    public $includepath = "../install/includes/";
    public $lcd;
    public $lstr = array();
    public $qrepl = array('|', ',', '  ');
    public $qwith = array(' | ', ', ', ' ');
    ...
    public function __construct() {
        ...
        require_once $this->rootpath."config/config.php"; global $db; $this->db = $db;
        global $lcd; $this->lcd = $lcd;
        global $lstr; $this->lstr = $lstr; 
