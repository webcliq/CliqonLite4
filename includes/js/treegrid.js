...
(function($) {
    ...
    $.fn.treegrid.defaults = {
        ...
        getTreeGridContainer: function() {
            return $(this).closest('table tbody');
        },
...
$.extend($.fn.treegrid.defaults, {
    expanderExpandedClass: 'glyphicon glyphicon-chevron-down click-cursor',
    expanderCollapsedClass: 'glyphicon glyphicon-chevron-right click-cursor'
});
