<?php
class clqcurl extends clq {
 
	public $tablename			= "clqdata";
	public $fieldid				= "id";
	public $contentfieldname	= "clq_text";
	public $idiomfieldname 		= "clq_langcd";
	public $iconpath 			= "";
	public $lstr				= array();
    ...
    function __construct($url = '') {
		...
		global $rootpath; global $cfg;
		
		$this->rootpath = $rootpath;
		global $lcd; $this->lcd = $lcd;
		$this->adminpath = $roopath."admin/";
		$this->iconpath = $this->adminpath."images/icons/";		
		$this->cfg = $cfg;
